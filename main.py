...
from algorithms_insertion_heuristics import calc_nearest_neighbor_tour, calc_in_order_tour, calc_furthest_neighbor_tour
...
def print_results_from_tsp_path(call_args, tsp_path):
    ...
    if call_args.need_EA_txt:
        print("EA AVERAGE LENGTH:        {}"
              .format(calc_EA_tour_txt(tsp)))
